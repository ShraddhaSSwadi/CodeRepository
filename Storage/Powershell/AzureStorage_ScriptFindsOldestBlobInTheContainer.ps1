#This script will help you if you in finding the oldest blob in the given container/directory 
...
$storageAccountKey = "your storage account access keys"
$containerName = "your container name"
$directoryName = "your directory"
